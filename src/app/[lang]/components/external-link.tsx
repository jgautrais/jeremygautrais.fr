...
export default function ExternalLink({icon, text, link, className}: Props) {
  ...
  return (
    <a href={link} rel="noopener noreferrer" target="_blank" className={`group flex bg-zinc-900 shadow-zinc-900/50 py-1.5 px-4 rounded-full hover:bg-teal-500 shadow-lg hover:shadow-md hover:shadow-teal-500/50 transition-all ease-in-out ${className}`}>
